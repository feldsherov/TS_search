"""
Django settings for ir_proj project.
...
SECRET_KEY = 'b4^y*%q&r01p!%zj+v@**to96o8j+u7^!-jcp4keboyyq802*r'
...
WSGI_APPLICATION = 'ir_proj.wsgi.application'
